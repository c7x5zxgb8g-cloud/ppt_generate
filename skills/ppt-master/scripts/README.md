...
- `extract_knowledge_points.py`: courseware-mode knowledge point and page-plan extractor
...
python3 scripts/extract_knowledge_points.py <source.md> -o <project_path>/sources/course_outline.json
...
| Courseware planning | `extract_knowledge_points.py` | Courseware Mode MVP |
